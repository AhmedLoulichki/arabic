		...
		<div class="container">
			...
			<!----content---->
							...
							<div class="col-md-3 product-filter-grid1-brands">
								...
								<?php
												...
												$query = mysql_query("SELECT * FROM matieres");
													echo '<li><a href="products.php?mati=Toute">Toute</a></li>';
													while($row = mysql_fetch_row($query))
													{	
														echo '<li><a href="products.php?mati='.$row[0].'">'.$row[0].'</a></li>';							
													}
									?>
							...
							<div class="col-md-6 product-filter-grid1-brands-col2">
									<div class="producst-cate-grids">
										<div class="col-md-4 producst-cate-grid text-center">
											...
											echo "<label>$numrows PRODUITS</label>";
											?>
										...
										<div class="col-md-4 producst-cate-grid text-center" class="col-md-6 unstyled-list b-list1">
											<h2>ENFANTS</h2>
				...
				<div class="special-products all-poroducts">
					<div class="s-products-head">
						...
						<div class="s-products-head-right">
							<a href="product_catalogue.php?catlg=FEMME"><span> </span>Tout les products</a>
						</div>
						<div class="clearfix"> </div>
					</div>
					...
					<?php
												...
												if(isset($_GET["mati"])){
														if($_GET["mati"]=='EVA'){
															$query = mysql_query("SELECT * FROM produit WHERE cat='FEMME' AND Matiere ='EVA' LIMIT 8");
														}elseif($_GET["mati"]=='Plorita'){
															$query = mysql_query("SELECT * FROM produit WHERE cat='FEMME' AND Matiere ='Plorita' LIMIT 8");
														}elseif($_GET["mati"]=='PVC'){
															$query = mysql_query("SELECT * FROM produit WHERE cat='FEMME' AND Matiere ='PVC' LIMIT 8");
														}else{
															$query = mysql_query("SELECT * FROM produit WHERE cat='FEMME'  LIMIT 8");
														}
												}else{
													$query = mysql_query("SELECT * FROM produit WHERE cat='FEMME' LIMIT 8");
												}
					...
					?>
											...
											<?php
													...
													if($numrows == 0){
															echo "Aucun résultat – aucun produit trouvé";
													}	
					...
					<div style="margin-left: 42%;">
							<a href="product_catalogue.php?catlg=FEMME"><span> </span>Tout les prodiuts</a>
						</div>
				</div>
				<!----->
								<!----speical-products---->
				<div class="special-products all-poroducts">
					<div class="s-products-head">
						<div class="s-products-head-left">
							<h3 id='HOMME'>PRODUITS POUR LES <span>HOMMES</span></h3>
						</div>
						<div class="s-products-head-right">
							<a href="product_catalogue.php?catlg=HOMME"><span> </span>Tout les products</a>
						</div>
						<div class="clearfix"> </div>
					</div>
					<!----special-products-grids---->
					...
					<?php
												...
												if(isset($_GET["mati"])){
														if($_GET["mati"]=='EVA'){
															$query = mysql_query("SELECT * FROM produit WHERE cat='HOMME' AND Matiere ='EVA' LIMIT 8");
														}elseif($_GET["mati"]=='Plorita'){
															$query = mysql_query("SELECT * FROM produit WHERE cat='HOMME' AND Matiere ='Plorita' LIMIT 8");
														}elseif($_GET["mati"]=='PVC'){
															$query = mysql_query("SELECT * FROM produit WHERE cat='HOMME' AND Matiere ='PVC' LIMIT 8");
														}else{
															$query = mysql_query("SELECT * FROM produit WHERE cat='HOMME'  LIMIT 8");
														}
												}else{
													$query = mysql_query("SELECT * FROM produit WHERE cat='HOMME' LIMIT 8");
												}
					...
					<!---//special-products-grids---->
					<div style="margin-left: 42%;">
							<a href="product_catalogue.php?catlg=HOMME"><span> </span>Tout les prodiuts</a>
						</div>
				</div>
				<!----->
				<div class="special-products all-poroducts">
					<div class="s-products-head">
						<div class="s-products-head-left">
							<h3 id='ENFANTS'>PRODUITS POUR LES <span>ENFANTS</span></h3>
						</div>
						<div class="s-products-head-right">
							<a href="product_catalogue.php?catlg=ENFANTS"><span> </span>Tout les prodiuts</a>
						</div>
						<div class="clearfix"> </div>
					</div>
					<!----special-products-grids---->
					...
					<?php
												...
												if(isset($_GET["mati"])){
														if($_GET["mati"]=='EVA'){
															$query = mysql_query("SELECT * FROM produit WHERE cat='ENFANTS' AND Matiere ='EVA' LIMIT 8");
														}elseif($_GET["mati"]=='Plorita'){
															$query = mysql_query("SELECT * FROM produit WHERE cat='ENFANTS' AND Matiere ='Plorita' LIMIT 8");
														}elseif($_GET["mati"]=='PVC'){
															$query = mysql_query("SELECT * FROM produit WHERE cat='ENFANTS' AND Matiere ='PVC' LIMIT 8");
														}else{
															$query = mysql_query("SELECT * FROM produit WHERE cat='ENFANTS'  LIMIT 8");
														}
												}else{
													$query = mysql_query("SELECT * FROM produit WHERE cat='ENFANTS' LIMIT 8");
												}
				...
				<div class="special-products all-poroducts latest-products">
					<div class="s-products-head">
						<div class="s-products-head-left">
							<h3 id='BOTTES'>PRODUITS DES <span>BOTTES</span></h3>
						</div>
						<div class="s-products-head-right">
							<a href="product_catalogue.php?catlg=BOTTES"><span> </span>Tout les prodiuts</a>
						</div>
						<div class="clearfix"> </div>
					</div>
					<!----special-products-grids---->
					...
					<?php
												...
												if(isset($_GET["mati"])){
														if($_GET["mati"]=='EVA'){
															$query = mysql_query("SELECT * FROM bottes LIMIT 8");
														}elseif($_GET["mati"]=='Plorita'){
															$query = mysql_query("SELECT * FROM bottes LIMIT 8");
														}elseif($_GET["mati"]=='PVC'){
															$query = mysql_query("SELECT * FROM bottes LIMIT 8");
